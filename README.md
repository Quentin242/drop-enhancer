...
Source code: [BSD-2-Clause](LICENSE). Full credits and upstream licenses: [THIRD_PARTY_NOTICES.md](THIRD_PARTY_NOTICES.md). Common, Rare, Very rare and collection-log sounds courtesy of **daanbom / Custom Sounds**, used with permission. Uncommon and Pet use original synthesized sounds. See [audio terms](AUDIO-PERMISSION.md).
