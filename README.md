...
Source code: [BSD-2-Clause](LICENSE). Full credits and upstream licenses: [THIRD_PARTY_NOTICES.md](THIRD_PARTY_NOTICES.md). Default sounds courtesy of **daanbom / Custom Sounds**, used with permission. See [audio terms](AUDIO-PERMISSION.md).
