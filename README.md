...
Source code: [BSD-2-Clause](LICENSE). Full credits and upstream licenses: [THIRD_PARTY_NOTICES.md](THIRD_PARTY_NOTICES.md). Bundled UniversalAudioSFX recordings retain separate [audio permission terms](AUDIO-PERMISSION.md).
