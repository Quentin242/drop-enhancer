...
Adapted drop configuration and sound/event selection into CustomSoundEvents and CelebrationConfig. Non-drop features and weapon mappings are not included. Replaced playback, scheduling and lifecycle management. Four default recordings are now supplied from Custom Sounds with author permission; see AUDIO-PERMISSION.md for their separate terms and exact sources. Full terms: licenses/custom-sounds.txt.
