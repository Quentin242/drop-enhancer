...
public enum KillCountKind {
	...
	private static final Map<String, String> CLUE_CASKET_LABELS =
		Map.of("beginner", "Beginner caskets: ", "easy", "Easy caskets: ", "medium", "Medium caskets: ", "hard", "Hard caskets: ", "elite",
			   "Elite caskets: ", "master", "Master caskets: ");
	...
	private static final Map<String, String> RAID_LABELS =
		Map.ofEntries(Map.entry("chambers of xeric", "CoX completions: "), Map.entry("chambers of xeric challenge mode", "CoX CM: "),
					  ...
					  Map.entry("theatre of blood: hard mode", "ToB Hard Mode: "), Map.entry("tombs of amascut", "ToA completions: "),
					  Map.entry("tombs of amascut: entry mode", "ToA Entry: "), Map.entry("tombs of amascut: expert mode", "ToA Expert: "));
