...
public class DropRateResolverTest
{
	...
	private static Map<String, Map<String, Double>> loadFixture()
	{
		...
		{
			return gson.fromJson(reader, new com.google.gson.reflect.TypeToken<Map<String, Map<String, Double>>>() {}.getType());
		}
		catch (Exception e)
		{
	...
	{
		assertEquals(resolver.dropProbability("Abyssal Sire", "Unsired"), resolver.dropProbability("ABYSSAL SIRE", "Unsired"), 0.0001);
	}
	...
	public void itemNameLookupResolvesAnUnambiguousItem()
	{
		...
		assertEquals(resolver.dropProbability("Cerberus", "Jar of souls"), resolver.dropProbabilityByItemName("Jar of souls"), 0.0001);
	}
	...
	{
		assertEquals(resolver.dropProbability("Shellbane gryphon", "Gull (pet)"), resolver.dropProbability("Shellbane gryphon", "Gull"),
					 0.0000001);
