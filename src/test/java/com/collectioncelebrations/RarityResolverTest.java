/* Derived from Enhanced, copyright (c) 2026 SnakeSteak. BSD-2-Clause; see licenses/enhanced.txt. */
...
public class RarityResolverTest
{
	 ...
	 */
	private static final class TestConfig implements CelebrationConfig
	{
		private RarityBasis basis = CelebrationConfig.super.rarityBasis();
		private int uncommon = CelebrationConfig.super.uncommonAt();
		private int rare = CelebrationConfig.super.rareAt();
		private int veryRare = CelebrationConfig.super.veryRareAt();
	...
	private static Map<String, RarityResolver.CompletionEntry> loadFixture()
	{
		...
		{
			return gson.fromJson(reader, new com.google.gson.reflect.TypeToken<Map<String, RarityResolver.CompletionEntry>>() {}.getType());
		}
		catch (Exception e)
		{
